package net.aerh.jigsaw.core.generator.skull;

/**
 * Defines each face of the player head cube (including hat layer faces), with UV mapping
 * coordinates for the Minecraft skin texture and a shadow intensity value.
 *
 * @param faceVertices indices into the vertex array defining this face's quad
 * @param shadow       shadow intensity (0-255), used to darken side/bottom faces
 * @param startX       UV x-coordinate in the skin texture for this face
 * @param startY       UV y-coordinate in the skin texture for this face
 */
public enum Face {
    ...
    public int[] faceVertices() { return faceVertices; }
